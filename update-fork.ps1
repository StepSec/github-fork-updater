...
# example calls:
# .\update-fork.ps1 -orgName "stepsec" -userName "xxx" -PAT $env:GitHubPAT $issueTitle "Parent repository for [stepsec/azure-docs] has updates available"
...
#$issueTitle = "Parent repository for [stepsec/pickles] has updates available"; $PAT=$env:GitHubPAT; $repoName = "stepsec/github-fork-updater"; $issueId = 24
