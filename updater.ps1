# example calls:
# .\updater.ps1 -orgName "stepsec" -userName "xxx" -PAT $env:GitHubPAT
param (
    [string] $orgName,
    [string] $userName,
    [string] $PAT,
...
# example parameters:
#$repoUrl = "https://api.github.com/repos/stepsec/test-repo"
#$orgName = "stepsec"
...
#$orgName = "stepsec"; $userName = "xxx"; $PAT = $env:GitHubPAT; $testingLocally = $true; $issuesRepository = "stepsec/github-fork-updater"
